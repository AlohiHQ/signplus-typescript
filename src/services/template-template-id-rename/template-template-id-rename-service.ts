...
import { RenameTemplateParams } from './request-params';
 ...
 */
export class TemplateTemplateIdRenameService extends BaseService {
  protected renameTemplateConfig: Partial<SdkConfig> = { environment: Environment.RESTAPI };

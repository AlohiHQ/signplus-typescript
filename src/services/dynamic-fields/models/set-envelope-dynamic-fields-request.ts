...
export const setEnvelopeDynamicFieldsRequest = z.lazy(() => {
  return z.object({
    dynamicFields: z.array(dynamicFields).optional().nullable(),
  });
});
...
export const setEnvelopeDynamicFieldsRequestResponse = z.lazy(() => {
  return z
    .object({
      dynamic_fields: z.array(dynamicFieldsResponse).optional().nullable(),
    })
    .transform((data) => ({
...
export const setEnvelopeDynamicFieldsRequestRequest = z.lazy(() => {
  return z
    .object({
      dynamicFields: z.array(dynamicFieldsRequest).optional().nullable(),
    })
    .transform((data) => ({

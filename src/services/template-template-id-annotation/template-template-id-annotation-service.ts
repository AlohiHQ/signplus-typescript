...
import {
  ...
  addTemplateAnnotationRequestRequest,
} from './models/add-template-annotation-request';
import { AddTemplateAnnotationParams } from './request-params';
 ...
 */
export class TemplateTemplateIdAnnotationService extends BaseService {
  protected addTemplateAnnotationConfig: Partial<SdkConfig> = { environment: Environment.RESTAPI };
  ...
  async addTemplateAnnotation(
    templateId: string,
    body: AddTemplateAnnotationRequest,
    params: AddTemplateAnnotationParams,
    ...
    const request = new RequestBuilder()
      ...
      .setRequestSchema(addTemplateAnnotationRequestRequest)

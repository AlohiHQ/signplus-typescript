...
/**
 * Zod schema for the AnnotationInitials model.
...
/**
 * Zod schema for mapping API responses to the AnnotationInitials application shape.
...
/**
 * Zod schema for mapping the AnnotationInitials application shape to API requests.

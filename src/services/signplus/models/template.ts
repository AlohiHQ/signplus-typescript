...
/**
 * Zod schema for the Template model.
...
/**
 * Zod schema for mapping API responses to the Template application shape.
...
/**
 * Zod schema for mapping the Template application shape to API requests.

...
/**
 * Zod schema for the AnnotationDateTime model.
...
/**
 * Zod schema for mapping API responses to the AnnotationDateTime application shape.
...
/**
 * Zod schema for mapping the AnnotationDateTime application shape to API requests.
